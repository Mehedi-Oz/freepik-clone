...
class ImageService
{
  ...
  public function buildFilters($requestParams)
  {
    ...
    // File type filter
    if (
      isset($requestParams['filetype']) &&
      in_array($requestParams['filetype'], ALLOWED_FILE_TYPES)
    ) {
    ...
    // People filter
    if (
      isset($requestParams['people']) &&
      in_array($requestParams['people'], ALLOWED_PEOPLE_VALUES)
    ) {
    ...
    // Orientation filter
    if (
      isset($requestParams['orientation']) &&
      in_array($requestParams['orientation'], ALLOWED_ORIENTATIONS) &&
      $requestParams['orientation'] != 'all'
    ) {
    ...
    // Color filter
    if (
      isset($requestParams['color']) &&
      in_array($requestParams['color'], ALLOWED_COLORS) &&
      $requestParams['color'] != 'all'
    ) {
    ...
    // License filter
    if (
      isset($requestParams['license']) &&
      in_array($requestParams['license'], ALLOWED_LICENSES) &&
      $requestParams['license'] != 'all'
    ) {
  ...
  protected function buildColorPattern($color)
  {
    $color_patterns = [
      'red' =>
      '#(ff|ed|ea|e6|c0|bf|bb|ba|b9|bc|b8|ae|a0|99|98|90|87|80|7f|70|c1|c2|c8|c9|ca|d4|44|55)[0-9a-f]{4}',
      'orange' =>
      '#(ff9|ffc|fba|faa|fcb|fca|d18|d08|ce9|dc9|e59|cc9|c9a|cba|cda|b85|b75|aa7|ac8|af8|9f7|dac)[0-9a-f]{3}',
      'yellow' => '#(fff|aaa|b6a|e1c|e2d|d5b|c8a|c9a|d0b|d1b|d3b)[0-9a-f]{3}',
      'green' =>
      '#(477|607|758|728|748|6b8|556|285|55d|50b|50a|56b|62b|69c|7eb|7db|849|89a|96d|a1e|b5c|b5b|b3b|64c)[0-9a-f]{3}',
      'blue' =>
      '#(2a2|006|4c8|4b8|4e7|356|546|6e6|636|6d9|6f9|6a9|768|718|599|598|588|568|85b|86b|8bb|a2c|a3c|aac|00a|5ba|63a|62a|4a2|4f2|621|631|641|637|7f2|300)[0-9a-f]{3}',
      ...
      'brown' =>
      '#(8b7|886|8a7|8a7|665|5a2|662|663|693|6b3|724|734|7c5|6f4|5d2|5c2|4d3|4e3|472|452|413|3a2|3b2|392|382|331|321|2f0|2d1|996|917|847)[0-9a-f]{3}',
    ];
